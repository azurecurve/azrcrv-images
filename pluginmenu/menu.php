 ...
 *
 */
if (!function_exists('azrcrv_create_plugin_menu_im')){
	function azrcrv_create_plugin_menu_im(){
		azrcrv_create_plugin_menu_table_im();
		azrcrv_populate_plugin_menu_table_im();
	}
}
 ...
 *
 */
if (!function_exists('azrcrv_populate_plugin_menu_table_im')){
	function azrcrv_populate_plugin_menu_table_im(){
		global $wpdb;
 ...
 *
 */
if (!function_exists('azrcrv_create_plugin_menu_table_im')){
	function azrcrv_create_plugin_menu_table_im(){
		global $wpdb;
		$table_name = $wpdb->base_prefix.'azrcrv_plugin_menu';
